			...
			<div class="col-lg-12 testimonial-wrap-2">
				<div class="testimonial-block style-2  gray-bg">
					...
					<div class="testimonial-thumb">
						<img src="{{asset('/front/')}}/images/team/test-thumb1.jpg" alt="" class="img-fluid">
					</div>
				...
				<div class="testimonial-block style-2  gray-bg">
					<div class="testimonial-thumb">
						<img src="{{asset('/front/')}}/images/team/test-thumb2.jpg" alt="" class="img-fluid">
					</div>
				...
				<div class="testimonial-block style-2  gray-bg">
					<div class="testimonial-thumb">
						<img src="{{asset('/front/')}}/images/team/test-thumb3.jpg" alt="" class="img-fluid">
					</div>
				...
				<div class="testimonial-block style-2  gray-bg">
					<div class="testimonial-thumb">
						<img src="{{asset('/front/')}}/images/team/test-thumb4.jpg" alt="" class="img-fluid">
					</div>
